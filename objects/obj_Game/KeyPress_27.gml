		...
		if(!l42B1B2AC_0)
		{
			...
			if(!l5FCA58D4_0)
			{
				...
				if(global.gameIsPaused)
				{
					...
					instance_create_layer(250, 410, "Instances_2", obj_pauseblock);
