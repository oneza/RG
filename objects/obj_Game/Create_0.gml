...
//ini_write_string(string(3), "Name", "default");
//ini_write_real(string(3), "Value", 0);
//ini_close()
...
global.skins[3, 0] = ini_read_string(string(3), "Name", "default");
global.skins[3, 1] = ini_read_real(string(3), "Value", 0);
ini_close()
