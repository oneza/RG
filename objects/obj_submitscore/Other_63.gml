...
if i_d == name
{
    ...
    {
        if (string_length(ds_map_find_value(async_load, "result")) > 12 || ds_map_find_value(async_load, "result") == "")//if the name entered is not blank or long
        {
